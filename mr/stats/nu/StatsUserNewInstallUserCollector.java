...
public class StatsUserNewInstallUserCollector implements ICollector {
	...
	public void collect(Configuration conf, BaseDimension key, BaseStatsValueWritable value, PreparedStatement pstmt,
		...
		// 3.设置对应sql的参数
		/**
		 * INSERT INTO `stats_user`( `platform_dimension_id`,
		 * `date_dimension_id`, `new_install_users`, `created`) VALUES(?, ?, ?,
